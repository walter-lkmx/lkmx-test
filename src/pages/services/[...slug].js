    ...
    return (
      <BaseLayout className={`${styles.prose}`}>
        ...
        <Page className={`${styles.service}`}>
          ...
          <Column
            mode="normal"
            className={styles.service__introduction}
            weight="left"
          >
            ...
            <Block>
              ...
              <div className={styles.service__subServices__cards}>
                {subServices.map((subService) => (
                  <div
                    key={subService.id}
                    className={styles.service__subServices__card}
                  >
                    <Link href={`/services/${serviceData.id}/${subService.id}`}>
                      <div
                        className={styles.service__subServices__card__content}
                      >
                        {subService.iconName && (
                          <div
                            className={styles.service__subServices__card__icon}
                          >
                            <Image
                              src={`/icons/${subService.iconName}.svg`}
                              width={32}
                              height={32}
                        ...
                        <div
                          className={styles.service__subServices__card__arrow}
                        >
                          <Image
                            width={24}
                            height={24}
